...
- Follow this implementation checklist:
  ...
  - Implement proper type definitions for all props (if using TypeScript)
...
e.g. I've created a plan at `.cursor/doc/{jira_ticket}/shadcn_ui.md` (or `.cursor/doc/{feature_name}/shadcn_ui.md` if no Jira ticket), please read that first before you proceed
...
- After you finish the work, MUST create the `.cursor/doc/{jira_ticket}/shadcn_ui.md` file (or `.cursor/doc/{feature_name}/shadcn_ui.md` if no Jira ticket) to make sure others can get full context of your proposed implementation
